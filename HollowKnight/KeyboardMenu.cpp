...
#define PATH_KEYBOARD "UIs/Menus/Options/Keyboard/Keyboard.png"
...
void KeyboardMenu::Init()
{
	...
	Label* _title = new Label(TextData("Keyboard", Vector2f(_halfWindowX, _titlePosY), FONT, 36));
	...
	ShapeWidget* _image = new ShapeWidget(ShapeData(_windowSize / 2.0f, Vector2f(747.0f, 334.0f), PATH_KEYBOARD));
