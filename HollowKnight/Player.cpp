...
void Player::SetupPlayerInput()
{
	...
	new ActionMap("Stats", {
		...
		ActionData("ShakePlayer " , [&]() {/*Game::GetCamera()->ShakeActor();*/ Game::GetCamera()->SetCanShake(true); } , InputData({ActionType::KeyPressed, Keyboard::K})),
		ActionData("StopShakePlayer ",  [&]() {new Timer([&]() {Game::GetCamera()->SetCanShake(false); } , milliseconds(static_cast<Int32>(5.0f))); } , InputData({ActionType::KeyReleased , Keyboard::K})),
